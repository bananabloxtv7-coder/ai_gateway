...
class SingleToolCallProbe(BaseProbe):
    @property
    ...
    async def run(self, route_id: str, client: Any) -> ProbeResult:
        ...
        result = await client.chat_completion(route_id, payload)
        return result
    ...
    def evaluate(self, result: ProbeResult) -> dict:
        ...
        if args.get("order_id") != 73921:
            ...
            base_eval["failure_message"] = f"Expected order_id=73921 but got {args.get('order_id')}"
            return base_eval
